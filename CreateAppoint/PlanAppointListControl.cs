...
namespace DispatcherService
{
    public partial class PlanAppointListControl : UserControl
    {
        ...
        private PlanAppointListControl()
        {
            ...
            btnAppointNotFound.Image = DispatcherService.Resources.Image.Right;
        }
        ...
        public EventHandler BtnNextPressed
        {
            get { return btnNextPressed; }
        }

        private void btnNextPressed(object sender, EventArgs e)
        {
            if (bsList.Current != null)
                OnItemSelected((PlanAppoint)bsList.Current);
            else
                MessageBox.Show(DispatcherService.Resources.Error.PlanAppointNotSelected, FindForm().Text);
        }
        ...
        private void btnAppointNotFound_Click(object sender, EventArgs e)
        {
            FormStart form = (FormStart)FindForm().MdiParent;

            OnItemSelected(new PlanAppoint(form.User));
        }
    }
}
